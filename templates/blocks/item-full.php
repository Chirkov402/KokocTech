...
$itemRent = array(
    ...
    4 => array(
        'title' => 'Бытовка склад 100 x 6000 см',
        'price' => 34
    )
    );
...
?>
        ...
        <div class="preview_bytovka-main">
          ...
          <div class="preview_bytovka-content"><a class="preview_bytovka-heading" href="/bytovka.php">Бытовка склад</a>
            <div class="preview_bytovka-gabarits"><?=$value['title'] ?></div>
            ...
            <div class="preview_bytovka-order">
              <div class="preview_bytovka-price">Цена: <span><?=$value['price']?> р</span></div>
              <div class="preview_bytovka-link"><a class="btn_pink" href="/rent.php" data-open="popup_order">Заказать</a></div>
